...
from model.L_layer_model_tf import *
...
Y_test = convert_to_one_hot(Y_test_orig, 17)

layers_dims=[X_train.shape[0], 25,12,17]
...
parameters=tf_L_layer_model_with_Adam(X_train, Y_train, X_test, Y_test,layers_dims, learning_rate, number_iter, minibatch_size, print_cost)
